...
//                 <p className="mt-2">
//                   <span className="font-medium">طريقة الشحن:</span> {order.shippingMethod === 'aramex' ? 'أرامكس' : 'شركة محلية'}
//                 </p>
//               </div>
...
//                 </h2>
//                 <p>
//                   <span className="font-medium">طريقة الدفع:</span> {order.paymentMethod === 'credit_card' ? 'بطاقة ائتمان' : order.paymentMethod}
//                 </p>
//                 <p>
//                   <span className="font-medium">حالة الدفع:</span> {order.paymentStatus === 'paid' ? 'تم الدفع' : 'قيد المعالجة'}
//                 </p>
//                 {order.couponUsed && (
//                   <p>
//                     <span className="font-medium">كود الخصم:</span> {order.couponUsed}
//                   </p>
//                 )}
//               </div>
//             </div>
...
//               <div className="mb-4">
//                 <p>
//                   <span className="font-medium">رقم الطلب:</span> {order._id}
//                 </p>
//                 <p>
//                   <span className="font-medium">تاريخ الطلب:</span> {formatDate(order.createdAt)}
//                 </p>
//               </div>
...
//                         <td className="py-3 px-4 text-right">{item.product?.name || 'غير معروف'}</td>
//                         <td className="py-3 px-4 text-center">{item.quantity}</td>
//                         <td className="py-3 px-4">{item.price} د.أ</td>
//                         <td className="py-3 px-4">{(item.price * item.quantity).toFixed(2)} د.أ</td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
...
//                     <span>الخصم:</span>
//                     <span>-{order.discountAmount} د.أ</span>
//                   </div>
//                 )}
//                 <div className="flex justify-between mb-2">
//                   <span>رسوم الشحن:</span>
//                   <span>{order.shippingFee} د.أ</span>
//                 </div>
