...
const WomenAccessories = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const response = await axios.get('http://localhost:5000/api/products/womenaccessories', {
        params: {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto py-8 px-4">
        <h2 className="text-2xl font-bold mb-6 pb-2 border-b border-gray-200">قسم الإكسسوارات النسائية</h2>
