...
//                 // onApprove={async (data, actions) => {
//                 //   try {
//                 //     // 1. الحصول على محتويات السلة
//                 //     const cart = JSON.parse(localStorage.getItem('cart')) || [];
//                 //     const productIds = cart.map(item => item.productId);

//                 //     // 2. تأكيد الدفع مع PayPal
//                 //     const paymentResponse = await axios.post(
//                 //       'http://localhost:5000/api/payments/capture-paypal-order', 
//                 //       {
//                 //         orderID: data.orderID,
...
//                 //     if (paymentResponse.data.success) {
//                 //       // 3. الحصول على عنوان الشحن (استخدام العنوان الذي أدخله المستخدم في الخطوة 1)
//                 //       // بدلاً من جلب العنوان الافتراضي، نستخدم العنوان الذي تم إدخاله في state
...
//                 //         })),
//                 //         shippingMethod,
//                 //         shippingAddress, // نرسل كائن العنوان مباشرة
//                 //         paymentMethod: 'paypal',
//                 //         couponCode: appliedCoupon?.code,
...
//                 //       // 8. توجيه المستخدم لصفحة التأكيد
//                 //       navigate('/thank-you', {
//                 //         state: {
//                 //           orderId: orderResponse.data.order._id,
//                 //           total: finalTotal
...
//                 //       });
//                 //     } else {
//                 //       throw new Error(paymentResponse.data.message || 'فشل في عملية الدفع');
//                 //     }
//                 //   } catch (error) {
//                 //     console.error("Capture order error:", error);
//                 //     alert(`حدث خطأ: ${error.response?.data?.message || error.message}`);
